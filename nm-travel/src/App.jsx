...
const calendarEvents = [
  ...
  { category: "Hotels", events: [
    { title: "🏨 Folies Corfu Town Hotel Apartments", start: "2026-06-25", end: "2026-06-29", allDay: true, location: "Alepou Xabai, Corfu, Greece", description: "Team (Jenna, Genevieve, Martina, Ruben) · 5 studios · Conf #5071.167.071 · PIN 1546 · NON-REFUNDABLE" },
    ...
    { title: "🌋 Villa Don Giovanni, Taormina", start: "2026-07-01", end: "2026-07-06", allDay: true, location: "Via Nazionale - Mazzarò, Taormina, Sicily", description: "Nick + Team · Conf #6775.843.228 · PIN 4148 · Cash on arrival · Private pool · Call +39 0942 24536 72hrs before" },
    ...
    { title: "⛰️ Aspen Hotel (TBD)", start: "2026-07-23", end: "2026-07-27", allDay: true, location: "Aspen, CO", description: "Nick & Miriam · Big Green Sat Jul 25 · TO BOOK" },
  ]},
  ...
  { category: "Activities", events: [
    ...
    { title: "🏛️ Acropolis Museum", start: "2026-06-30", end: "2026-07-01", allDay: true, location: "Dionysiou Areopagitou 15, Athens, Greece", description: "Athens day with Nick & Miriam" },
  ...
  { category: "Reminders", events: [
    ...
    { title: "📋 Book SEA → ASE Flight (Aspen)", start: "2026-06-01", end: "2026-06-02", allDay: true, location: "", description: "Book Nick & Miriam: Seattle/Vashon → Aspen (Thu Jul 23) via DEN or SLC" },
    { title: "🏨 Book Aspen Hotel (Jul 23–27)", start: "2026-06-01", end: "2026-06-02", allDay: true, location: "Aspen, CO", description: "Nick & Miriam · Big Green Sat Jul 25 · Book hotel for Jul 23–27" },
    { title: "✈️ Book CFU → ATH Flight (Jun 29)", start: "2026-06-01", end: "2026-06-02", allDay: true, location: "", description: "Nick & Miriam: Corfu → Athens (Mon Jun 29) for Monument check-in 3pm" },
    { title: "✈️ Book ATH → CTA Flight (Jul 1)", start: "2026-06-01", end: "2026-06-02", allDay: true, location: "", description: "Nick & Miriam: Athens → Catania → Taormina (Wed Jul 1)" },
    { title: "✈️ Book CTA → OLB Flight (Jul 6)", start: "2026-06-01", end: "2026-06-02", allDay: true, location: "", description: "Full team: Catania → Olbia/Sardinia (Mon Jul 6)" },
  ]},
];
            ...
            {!unlocked ? (
              ...
              <div>
                <div style={{ display:"flex", justifyContent:"space-between", alignItems:"center", marginBottom:20 }}>
                  ...
                  <button onClick={() => { setUnlocked(false); setPwInput(""); }} style={{ background:"none", border:"1px solid #2a2535", borderRadius:6, color:"#5a6070", fontFamily:"'DM Mono',monospace", fontSize:9, letterSpacing:"0.12em", padding:"5px 10px", cursor:"pointer" }}>LOCK</button>
                </div>
